...
~~~
export POSDIR=$TAGDIR_POS
export NEGDIR=$TAGDIR_NEG
...
#
time snakemake -s ${TAGOOS}/snakefile/heatmap.yml -p -j $NBCHROM -c "qsub -X -V -d $OUTDIR -q tagc -l nodes=1:ppn={threads} -e $OUTDIR/stderr.log -o $OUTDIR/stdout.log" -d $OUTDIR -pn
~~~
