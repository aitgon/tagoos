...
time snakemake -s ${TAGOOS}/snakefile/annotation/merge_annotations.yml -p -j 16 -c "qsub -X -V -q tagc -l nodes=1:ppn={threads} -e $ENCODE2_DATA_DIR/stderr.log -o $ANNOTATION_DIR/stdout.log" -d $ANNOTATION_DIR -pn
~~~
...
export SCRIPTDIR=$HOME/data/2015_svmgwas/repositories/tagoos/script
time snakemake -s ${TAGOOS}/snakefile/preannotate.yml -j 32 -c "qsub -X -V -q tagc -l nodes=1:ppn={threads} -e tmp/stderr.log -o tmp/stdout.log" -d $SNP_DIR -pn
~~~
