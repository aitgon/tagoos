# GRASP108.rsid, 1kg1000.rsid, annotation, index1## height.rsid, 1kg3000.rsid, annotation, index2
...
# GRASP108.rsid, 1kg10000.rsid, annotation, index1
...
# GRASP108.rsid, 1kg30000.rsid, annotation, index1

~~~
export POS_LABEL=GRASP108
export NEG_LABEL=1kg30000
export ANNOT_LABEL=annotation
export INDEX_LABEL=index
#
export OUTDIR=$PWD/out/${POS_LABEL}/${NEG_LABEL}_${ANNOT_LABEL}_${INDEX_LABEL}
...
# GRASP108.rsid, 1kg100000.rsid, annotation, index1
...
# GRASP108.rsid, 1kg1000000.rsid, annotation, index1
